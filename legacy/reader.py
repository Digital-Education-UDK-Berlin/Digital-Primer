...
from narrator_navigator import Navigator
...
class recorder(threading.Thread):
    ...
    def __init__(self,eventqueue,audio_dir,logger):
        ...
        self.logger = logger
        self.filemanager = filemanager(audio_dir)
...
def start_reader():
    ...
    folio_instance = Navigator(q_folio_input, q_folio_output, screendriver, test_texts, [])
